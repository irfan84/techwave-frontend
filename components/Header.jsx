...
const Header = () => {
  ...
  return (
    <header
      className={`w-full h-[50px] md:h-[80px] bg-white flex items-center flex-between z-20 sticky top-0 transition-transform duration-300 ${show}`}
    >
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
            ...
            <div
              ...
              items-center justify-center px-[2px] md:px-[5px]"
            >
              51
            </div>
          </div>
          ...
          <Link href="/cart">
            <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative">
              ...
              <div
                className="min-w-[14px] md:min-w-[18px] h-[14px] md:h-[18px] rounded-full bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[12px] flex 
              items-center justify-center px-[2px] md:px-[5px]"
              >
                5
              </div>
